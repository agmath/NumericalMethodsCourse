...
Navigate to your Google Drive and open a new Colab notebook or [create a copy of this *ready to go* notebook](https://colab.research.google.com/drive/1TJSmoRkBTAQABnpeksx5snvc9bzzYeMG?usp=drive_link).
...
**Task 2:** We'll sometimes want to utilize fractions, we can do this using \frac{numerator}{denominator}. Add the required dollar signs to format the rational function r(x) = (x + 3)/(x - 5) as math type. Use \\frac{}{} to further format the function. Finally, wrap the entire function in \\displaystyle{} to improve readability.
...
**Task 4:** Define a $5\times 4$ matrix using any entries you like.
...
*Hint.* Look back to our previous day's notebook or discussion slides for help.
