...
+ [Python via Google Colab](https://colab.research.google.com/) or a local Python installation is required (Colab recommended)
    ...
    + You'll also use $\LaTeX$ inside of the Colab environment for typesetting mathematics, but I'll give you a primer in that as well.
...
Open a new Colab notebook from your Google Drive or open the pre-built [Day 1 Notebook](https://colab.research.google.com/drive/1HI1jjQwaNEvCqhO0oB6G0poNf8U0xhAR?usp=share_link) and let's get started.
...
+ In particular, you should feel free to copy/paste/edit from this notebook.
+ We'll spend additional time over the coming days gaining more familiarity and comfort with Python.
